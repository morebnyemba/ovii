...
class AgentCashInView(generics.CreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        try:
            ...
            return Response({"detail": "Cash-in successful."}, status=status.HTTP_201_CREATED)
...
class CustomerCashOutRequestView(generics.CreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        try:
            ...
            return Response({"detail": "Cash-out successful. Please collect your cash from the agent."}, status=status.HTTP_201_CREATED)
        except (TransactionError, TransactionLimitExceededError) as e:
            return Response({"detail": str(e)}, status=status.HTTP_400_BAD_REQUEST)