  ...
  if (!user || user.role !== "AGENT") {
    return (
      <div className="flex justify-center items-center h-screen">
        <p>Loading agent dashboard or redirecting...</p>
      </div>
    );
  }

  const agentProfile = user.agent_profile; // Assuming agent_profile is attached to user

  return (
    <div className="container mx-auto py-10">
      <h1 className="text-3xl font-bold mb-6">Welcome, {agentProfile?.business_name || user.first_name}!</h1>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 mb-8">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{agentProfile?.commission_rate || "0.00"}%</div>
            <p className="text-xs text-muted-foreground">
      ...
      <div className="mb-8">
        ...
        <Button variant="link" className="mt-4" onClick={() => router.push("/agents/transactions")}>
